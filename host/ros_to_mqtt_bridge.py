...
# sample code to send data from ros to a topic in MQTT broker in the cloud 
# from ROS to mqtt. 
...
def main():
    ...
    bridge = ToMqttBridge(mqtt_topic="ABC", host=CONFIG.MQTT_BROKER.IP_ADDRESS, port=1883, qos=2)
